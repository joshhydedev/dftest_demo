trigger DreamTeamTaskCompleted on BLND_DFDT_Task__c (after update) {
    ...
    try {
        ...
        emailSubject = 'DreamTeam Tasks Completed';
        emailTextBody = 'The following DreamTeam tasks have been completed.\r\n\r\n';
        emailHtmlBody = 'The following DreamTeam tasks have been completed.\r\n\r\n';
        for(BLND_DFDT_Task__c t: Trigger.new) {
            ...
            if ((oldt.BLND_Complete__c < 100.0) && (t.BLND_Complete__c >= 100.0)) {
				...
				chatterStrings.add('completed a DreamTeam task.\r\n\r\n' + chatterBody);
